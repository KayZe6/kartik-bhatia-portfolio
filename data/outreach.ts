...
/** S5 in the copy deck, in display order. */
export const outreach: OutreachEntry[] = [
  {
    slug: "autodesk-design-make-ambassador",
  ...
  },
  {
    ...
    title: "NASA L.U.C.Y Mission Ambassador",
    dateRange: "Sep 2024 to Aug 2025",
    description:
  ...
  {
    slug: "undergraduate-teaching-assistant-enae-100",
    title: "Undergraduate Teaching Assistant, ENAE 100",
    org: "UMD Department of Aerospace Engineering",
    dateRange: "Sep to Dec 2025",
    description:
  ...
  {
    slug: "conference-panel-moderator",
    title: "Conference Panel Moderator",
    org: "Space Tech Expo USA, Long Beach, CA",
    dateRange: "May 2024",
    description:
